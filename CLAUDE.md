...
# Last updated: 2026-05-21 (Session 27 — versioning + build stamp (VERSION + version.py; footer + result owl_version provenance); CR-037 live-card readout bug fixed; CR-037/CR-040/CR-027 full bodies migrated to CHANGE_REQUESTS_CLOSED.md (active back to 17 CRs). 237 tests.)
...
# See also: CHANGE_REQUESTS.md — active CRs only (18 entries; CR-044 captured 2026-05-22 — VMAF quality score on video comparison cards, in build, feasibility proven; CR-043 captured 2026-05-14 — video preview in result card, deferred behind CR-039). Tracks: A storage/persistence (CR-012 + CR-031 storage section + downstream CR-003 / CR-007), B confidence model (CR-028 Phase 2 — Tania reply pending), C widget extensions (CR-024, CR-035, deferred resume-job), D result rendering / framing (shipped — CR-037 AI tethering + CR-027 tier copy both closed S26), E small polish (CR-007), F strategic / exploratory (CR-008, CR-009, CR-018 T2/T3, CR-025, CR-029, CR-033, CR-039 quality judge, CR-041 chip-age), G member trust (CR-040 reproducibility kit closed S26). See "Groupings & dependencies" appendix at end of CHANGE_REQUESTS.md for the full dependency map.
# See also: CHANGE_REQUESTS_CLOSED.md — closed CRs archive (CR-001, CR-001b, CR-002, CR-005, CR-006, CR-010, CR-011, CR-014, CR-015, CR-016, CR-017, CR-019, CR-020, CR-021, CR-022, CR-023, CR-026, CR-027, CR-030, CR-032, CR-034, CR-036, CR-037, CR-038, CR-040, CR-042). Each entry preserves the original problem statement and direction; Status line names the closing commit. (Mostly "shipped"; CR-005 was resolved S24 by investigation — not feasible on GoS1's hardware, no code. S26 closed CR-037 + CR-040; CR-027 was found already-implemented and closed.)
...
**Active CRs:** see `CHANGE_REQUESTS.md` (18 entries — CR-003 iso-energy, CR-004 graphing, CR-007 carbon variance, CR-008 REM↔OWL, CR-009 web client, CR-012 calibration history, CR-018 T2/T3 historical, CR-024 probe button, CR-025 RT Linux, CR-028 confidence model, CR-029 encoding rigor, CR-031 portability, CR-033 curated demo video, CR-035 encode progress bar, CR-039 energy-vs-quality axis for AI *(exploratory; tension with CR-029 §6 to resolve)*, CR-041 new-vs-aged silicon benchmark *(opportunistic)*, CR-043 video preview in result card *(deferred; rides on CR-039 retention plumbing)*, CR-044 VMAF quality score on video comparison cards *(in build — feasibility proven 2026-05-22)*). **Recently closed:** in the S26 credibility-bundle — CR-037 (AI→streaming tethering), CR-040 (reproduce-this bundle), CR-027 (tier copy — found already shipped); earlier CR-005 (software fan control — resolved S24 by investigation, no code) and the 2026-05-12 sweep CR-032 / CR-034 / CR-036 / CR-038 / CR-042 — all in `CHANGE_REQUESTS_CLOSED.md`. CR-019 resume-job hook deferred to a follow-up CR — capture if/when it surfaces in real visitor traffic. See "Groupings & dependencies" appendix at end of `CHANGE_REQUESTS.md` for cross-CR dependencies.
...
- [x] **Variance recalibration at the post-S24 HW baseline** — done 2026-05-14 (Session 25). Overnight n=32 / cooldown 10s on `meridian_4k.mp4`, ~2h47m wall (00:24 → 03:12), with the per-window idle-CV split + watchdog-timer suppression from `64d65d4` in effect: **idle 2.30% / drift 1.10% / cpu 0.95% / gpu 0.63% → `variance_pct` 1.29%**. Steady idle ~56-58 W confirmed. Cleanest calibration on record; matches the S23 n=6 verification value at much larger sample. *Prior runs for reference:* 2026-05-05 overnight n=24 / cooldown 90 / `gpu_encode_max_s=90` → idle 2.41 / cpu 1.33 / gpu 4.77 / **2.84**; 2026-05-07 post-CR-022 quick n=6 (full encodes) → idle 2.26 / cpu 0.66 / gpu 0.95 / **1.29**; 2026-05-13 preliminary n=12 / cooldown 20 (pre-watchdog-suppression) → idle 8.62 / cpu 3.56 / gpu 2.08 / **2.40** (inflated by `owl-maintenance-watchdog.timer` bumps — fixed in `64d65d4`).
