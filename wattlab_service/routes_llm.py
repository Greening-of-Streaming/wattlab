...
""", body=f"""
    ...
    <details>
        ...
        <p><b>{panel_n}-model panel:</b> {panel_list}. All on GoS1 (Ryzen 9 7900 + {ui._gpu_display_name()}, Ollama 0.20.2). Panel reflects the current <code>llm.MODELS</code> dict; the showcase tabs are frozen on the older 5-model probe and will be re-baselined when a fresh probe of the new panel runs.</p>
