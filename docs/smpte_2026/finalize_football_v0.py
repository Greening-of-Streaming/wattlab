#!/usr/bin/env python3
"""
finalize_football_v0.py — same field-renaming step as finalize_readysetgo_v0.py,
applied to the 2026-09-03 football sports-tier sweep: swap the primary `vmaf` field to the v0.6.1 rescore (matching the
...
Input: results/calibration/_staging/encode_parity_football_2026-09-03.json (84 rows,
...
SRC = STAGING / "encode_parity_football_2026-09-03.json"
OUT = STAGING / "encode_parity_football_2026-09-03_final.json"
...
out["protocol"]["note"] = (
    "Rescored 2026-09-04: sweep ran under the live service's then-default "
    ...
    "override (bin/rescore-football-v0.py) to match the v0.6.1 convention "
