#!/usr/bin/env python3
"""
rescore-readysetgo-v0.py — fix the VMAF-version mismatch in the 2026-08-28
ReadySetGo sport-clip encode-parity sweep.
...
ARTIFACT = Path(__file__).resolve().parent.parent / "results" / "calibration" / "_staging" / \
    "encode_parity_readysetgo_2026-08-28.json"
REF_DIR = Path("/tmp/wattlab_parity_clips")
REF = REF_DIR / "readysetgo_30s_looped_30s.mp4"
OUT_DIR = Path("/tmp/wattlab_rescore_v0_readysetgo")
